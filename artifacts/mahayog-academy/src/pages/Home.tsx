...
const PATHS = [
  ...
  },
  {
    ...
    overlay: "bg-gradient-to-t from-[#1a0f05]/50 to-transparent",
    desc: "From building Vedic learning centers and caring for sacred cows to serving daily free meals and nurturing youth — selfless service as the highest spiritual practice.",
  },
];
          ...
          <div className="grid md:grid-cols-2 items-center">
            ...
            <div className="px-10 md:px-16 py-16 bg-[#faf9f6]">
              ...
              <p className="text-base text-[#5a5248] leading-relaxed mb-5">
                Born in the Himalayan foothills of Nepal, His Holiness has an unwavering commitment to the inner awakening of all beings and collective human welfare. He is a rare spiritual master with the ability to awaken Kundalini and transmit experiential knowledge of the chakra system and advanced states of consciousness.
              </p>
              <p className="text-base text-[#5a5248] leading-relaxed mb-8">
                His life reflects profound depth of yogic attainment, including publicly demonstrated Bhu Samadhis — underground burials in meditation. Through his teachings, once-guarded Himalayan practices have been made accessible to the modern world, while preserving their authenticity and purpose.
              </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Link href="/gurukul">
              <div className="group bg-white rounded-2xl border border-[#e8dece] hover:shadow-xl hover:shadow-[#b8892a]/10 hover:-translate-y-0.5 transition-all duration-300 overflow-hidden flex flex-col h-full cursor-pointer">
                ...
                <div className="p-7 flex flex-col flex-1">
                  <h3 className="font-['Cormorant_Garamond'] text-2xl font-light text-[#2e2820] mb-3 leading-snug">Jagadguru Ramanandacharya Gurukul</h3>
            ...
            <Link href="/projects">
              <div className="group bg-white rounded-2xl border border-[#e8dece] hover:shadow-xl hover:shadow-[#b8892a]/10 hover:-translate-y-0.5 transition-all duration-300 overflow-hidden flex flex-col h-full cursor-pointer">
                <div className="relative h-52 overflow-hidden">
                  <img src={`${b}images/hanuman-temple-portrait.png`} alt="108 Hanuman Temples" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" style={{ objectPosition: "50% 30%" }} />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#1a0f05]/60 to-transparent" />
