  ...
  return (
    <div className="bg-[#faf9f6] text-[#3d3830]" style={{ scrollBehavior: "smooth" }}>
      ...
      <div className="relative border-y border-[#e8d5b0] py-8 px-6 text-center overflow-hidden">
        {/* Background image */}
        <img src={`${b}images/ashram-garden.jpg`} alt="" aria-hidden className="absolute inset-0 w-full h-full object-cover object-center pointer-events-none" />
        {/* Warm cream overlay */}
        <div className="absolute inset-0 bg-[#faf6ef]/92 pointer-events-none" />
