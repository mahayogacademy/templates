...
const inputCls = "w-full bg-white/70 border border-[#c8a050]/40 text-[#3d3830] placeholder-[#b0956a] rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-[#b8892a] transition-colors";
const selectCls = `${inputCls} appearance-none`;
const labelCls = "block text-[10px] uppercase tracking-[0.2em] text-[#7a4a08] mb-1.5 font-medium";
      ...
      >
        ...
        {submitted ? (
          <div className="max-w-md mx-auto text-center bg-white border border-[#b8892a]/30 rounded-2xl p-10 shadow-sm">
            ...
            <p className="font-['Cormorant_Garamond'] text-2xl font-light text-[#3d3830]">Enrolment Submitted</p>
            <p className="text-sm text-[#7a7068] mt-3">Your registration has been received. We will be in touch soon with your portal access details.</p>
          </div>
        ) : (
          <div className="max-w-2xl mx-auto">
            ...
            <form onSubmit={handleSubmit}>
              <div className="bg-[#fdf6ec]/90 backdrop-blur-sm border border-[#c8a050]/30 rounded-2xl p-7 space-y-5">
                ...
                {step === 1 && <>
                  <p className="font-['Cormorant_Garamond'] text-xl font-light text-[#3d2008] mb-2">Personal Details</p>
                ...
                {/* Step 2 – Education */}
                {step === 2 && <>
                  <p className="font-['Cormorant_Garamond'] text-xl font-light text-[#3d2008] mb-2">Education & Background</p>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-[#7a5a30] mt-1">Please be as specific as possible.</p>
                  </div>
                  <div>
                ...
                {step === 4 && <>
                  <p className="font-['Cormorant_Garamond'] text-xl font-light text-[#3d2008] mb-2">Emergency Contact</p>
                  <div>
                ...
                {/* Step 5 – Reference */}
                {step === 5 && <>
                  <p className="font-['Cormorant_Garamond'] text-xl font-light text-[#3d2008] mb-1">Reference <span className="text-sm text-[#7a5a30] font-sans font-normal">(Optional)</span></p>
                  <p className="text-xs text-[#7a5a30] mb-4">If someone referred you to this course, please share their details.</p>
                  <div>
                ...
                {/* Step 6 – Login */}
                {step === 6 && <>
                  <p className="font-['Cormorant_Garamond'] text-xl font-light text-[#3d2008] mb-1">Login Details</p>
                  <p className="text-xs text-[#7a5a30] mb-4">These credentials will give you access to your student portal, where the Zoom class link will be available. Please save them carefully.</p>
                  <div>
              ...
              <div className="flex items-center justify-between mt-6">
                {step > 1 ? (
                  <button type="button" onClick={() => setStep(s => s - 1)} className="px-6 py-3 rounded-full border border-[#c8a050]/50 text-[#7a4a08] text-sm hover:border-[#b8892a] transition-colors bg-white/40">
                    ← Back
                  </button>
                ) : <div />}
