  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Session timings vary by center. As a general guide, morning sessions usually begin around 6:00 AM and evening sessions begin around 6:00 PM. Sessions run for approximately two hours each day. Confirmed timings will be communicated to you after registration. For in-person centers, contact your center directly for the exact schedule.",
      },
      {
      ...
      >
        ...
        <div className="relative z-10 max-w-2xl mx-auto text-center">
          ...
          <h2 className="font-['Cormorant_Garamond'] text-5xl md:text-6xl font-light text-white leading-tight mb-4">
            Your Awakening<br />Begins with a Step
          </h2>
          <p className="text-[#c8b08a] text-base leading-relaxed mb-10 max-w-md mx-auto">
            The next workshop is open for registration. Join seekers from around the world on the path of inner transformation.
          </p>
          <Link
            href="/register?for=meditation"
