...
export default function AboutAcademy() {
  ...
  const dimensions = (t("about.foundation.dimensions", { returnObjects: true }) as string[]) ?? [];

  const PILLARS = [
    { key: "swastha",   img: `${b}images/pillar-swastha.png`   },
    { key: "sikshya",   img: `${b}images/pillar-sikshya.png`   },
    { key: "sanskar",   img: `${b}images/pillar-sanskar.png`   },
    { key: "sadvritta", img: `${b}images/pillar-sadvritta.png` },
    { key: "samriddhi", img: `${b}images/pillar-samriddhi.png` },
    { key: "shanti",    img: `${b}images/pillar-shanti.png`    },
  ];

  const DISCOVER = [
    { key: "meditation", img: `${b}images/meditation-hero.png`,    href: "/meditation"   },
    { key: "vedanta",    img: `${b}images/discover-programs.png`,  href: "/vedanta"      },
    { key: "ashram",     img: `${b}images/discover-ashram.png`,    href: "/ashram"       },
    { key: "guru",       img: `${b}images/saint-siddhababa.png`,   href: "/founder-guru" },
  ];
    ...
    <div className="bg-[#faf9f6] text-[#3d3830]" style={{ scrollBehavior: "smooth" }}>
      ...
      <section id="foundation" className="py-20 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-14 items-start">
          ...
          <div>
            <img
              src={`${b}images/about-ancient-wisdom.png`}
              alt={t("about.foundation.imgAlt")}
      ...
      <section id="pillars" className="py-20 px-6 bg-gradient-to-b from-[#fdf6ec] to-[#faf9f6]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <span className="uppercase tracking-[0.25em] text-xs text-[#b8892a] font-medium">{t("about.pillars.eyebrow")}</span>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-5">
            {PILLARS.map((p) => {
              const title = t(`about.pillars.items.${p.key}.title`);
              const label = t(`about.pillars.items.${p.key}.label`);
              const desc  = t(`about.pillars.items.${p.key}.desc`);
              return (
                <div
                  key={p.key}
      ...
      <section id="discover" className="relative py-20 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <span className="uppercase tracking-[0.25em] text-xs text-[#b8892a] font-medium">{t("about.discover.eyebrow")}</span>
            <h2 className="font-['Cormorant_Garamond'] text-4xl font-light text-[#3d3830] mt-2">{t("about.discover.heading")}</h2>
          </div>

          <div className="divide-y divide-[#d8c9b0]/60">
            {DISCOVER.map((item) => {
              const title = t(`about.discover.items.${item.key}.title`);
              const desc  = t(`about.discover.items.${item.key}.desc`);
              const tag   = t(`about.discover.items.${item.key}.tag`);
              return (
                <Link key={item.key} href={item.href}>
                  <div className="group flex items-center gap-8 py-7 hover:bg-white/50 transition-colors duration-300 px-4 -mx-4 rounded-xl cursor-pointer">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-base text-[#7a7068] leading-relaxed line-clamp-2">{desc}</p>
                    </div>
