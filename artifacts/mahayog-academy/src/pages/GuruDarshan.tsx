...
const WAYS = [
  {
    ...
    desc: "Visit His Holiness at the head ashram in Baharachettra, Nepal. Direct proximity, personal blessing, and immersion in the ashram's living spiritual atmosphere.",
