...
const WAYS = [
  {
    ...
    desc: "Seekers are welcome to visit His Holiness at the head ashram in Baharachettra, Nepal. In-person darshan offers direct proximity, blessing, and immersion in the ashram's living spiritual atmosphere.",
    detail: "Contact the ashram to confirm availability before visiting.",
  ...
  },
  {
    ...
    desc: "For those unable to travel, His Holiness extends his grace through live online satsangs — teachings, meditation guidance, and the experience of his presence, accessible from anywhere in the world.",
  ...
  },
  {
    ...
    desc: "During festivals, Yagyas, and special gatherings, His Holiness holds extended darshan for all present. These occasions are considered especially auspicious for receiving blessings.",
    detail: "Events are announced through the Academy's channels. Contact us to stay informed.",
