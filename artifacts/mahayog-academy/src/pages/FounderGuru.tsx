        ...
        <div className="max-w-5xl mx-auto">
          <div id="ashrams" className="scroll-mt-24">
            ...
            <div className="mb-16 space-y-3">
              ...
              {/* Row 1 — full-width silhouette banner */}
              <div className="relative overflow-hidden rounded-2xl" style={{ height: "340px" }}>
                <img
                  src={`${b}images/ashram-hanuman-sunset.jpg`}
                  alt="Hanuman statue at sunset, Sewa Pith Ashram"
                  className="w-full h-full object-cover"
                  style={{ filter: "sepia(25%) saturate(80%) brightness(0.92) contrast(1.05)" }}
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#2e2820]/50 to-transparent" />
                <p className="absolute bottom-4 left-5 text-xs text-white/80 tracking-[0.15em] uppercase">Sewa Pith Ashram · Nepal</p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="relative overflow-hidden rounded-2xl" style={{ height: "240px" }}>
                  <img
                    ...
                    className="w-full h-full object-cover"
                    style={{ filter: "sepia(20%) saturate(85%) brightness(0.95)" }}
                  />
                </div>
                <div className="relative overflow-hidden rounded-2xl" style={{ height: "240px" }}>
                  <img
                    src={`${b}images/ashram-prasad-2.jpg`}
                    alt="Community prasad meal at the ashram"
                    className="w-full h-full object-cover"
                    style={{ filter: "sepia(20%) saturate(85%) brightness(0.95)" }}
                  />
                </div>
                <div className="relative overflow-hidden rounded-2xl" style={{ height: "240px" }}>
                  <img
                    ...
                    alt="Devotees in the ashram herb garden"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="relative overflow-hidden rounded-2xl" style={{ height: "260px" }}>
                  <img
                    ...
                    alt="Sacred cows at sunset on ashram grounds"
                    className="w-full h-full object-cover"
                    style={{ filter: "sepia(22%) saturate(80%) brightness(0.93)" }}
                  />
                </div>
                <div className="grid grid-rows-2 gap-3" style={{ height: "260px" }}>
                  <div className="relative overflow-hidden rounded-2xl">
                    <img
                      src={`${b}images/ashram-cows-1.jpg`}
                      alt="Devotee with sacred cows at ashram gate"
                      className="w-full h-full object-cover"
                      style={{ filter: "sepia(20%) saturate(85%) brightness(0.95)" }}
                    />
                  </div>
                  <div className="relative overflow-hidden rounded-2xl">
                    <img
                      ...
                      alt="Devotees receiving prasad at the ashram"
                      className="w-full h-full object-cover"
                      style={{ filter: "sepia(20%) saturate(85%) brightness(0.95)" }}
                    />
                  </div>
              ...
              <div className="relative overflow-hidden rounded-2xl" style={{ height: "300px" }}>
                <img
                  ...
                  alt="Hanuman statue at the ashram temple"
                  className="w-full h-full object-cover object-top"
                  style={{ filter: "sepia(20%) saturate(85%) brightness(0.95)" }}
                />
              </div>
