    ...
    <div className="min-h-screen bg-[#faf9f6] font-['Inter']">
      ...
      <section className="relative h-[60vh] min-h-[420px] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img
            ...
            alt="Jagadguru Ramanandacharya Gurukul — sacred learning at Barahakshetra"
        ...
        <div className="relative z-10 text-center px-6 max-w-3xl mx-auto">
          ...
          <h1 className="font-['Cormorant_Garamond'] text-4xl md:text-6xl font-light text-white leading-tight">
            Jagadguru Ramanandacharya<br /><span className="text-[#e8c56a]">Gurukul</span>
          </h1>
          ...
          <div className="flex items-center justify-center gap-4 mt-8 flex-wrap">
            ...
            <Link
              href="/donate"
              className="inline-flex items-center gap-2 bg-[#f5ede0]/90 hover:bg-[#f5ede0] text-[#3d3830] text-sm px-7 py-3 rounded-full tracking-wider transition-colors duration-200"
            >
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-start">
            <div className="space-y-5 text-[#4a3728] text-base leading-relaxed">
              <p>
                Under the divine guidance of <span className="font-medium text-[#2c1a08]">His Holiness Jagadguru Mahayogi Siddhababa</span>, Jagadguru Ramanandacharya Gurukul opens its doors at the sacred grounds of Chataradham, Barahakshetra.
              </p>
              <p>
                    ...
                    {[
                      ...
                      <div key={tel} className="flex items-center gap-2 flex-wrap">
                        ...
                        <a
                          ...
                          className="inline-flex items-center gap-1 text-sm px-2 py-0.5 rounded-full bg-[#25d366]/10 text-[#1a9e4d] border border-[#25d366]/30 hover:bg-[#25d366]/20 transition-colors font-medium"
                        >
          ...
          <div className="rounded-3xl overflow-hidden grid md:grid-cols-2 shadow-xl border border-[#b8892a]/15">
            ...
            <div className="bg-[#fdf8f2] px-10 py-12 flex flex-col justify-start">
              ...
              <div className="mt-8 rounded-2xl bg-[#b8892a]/8 border border-[#b8892a]/20 px-5 py-4">
                <p className="text-[#b8892a] text-sm uppercase tracking-[0.2em] font-medium mb-2">Full sponsorship — one year</p>
                <div className="flex items-baseline gap-3">
                  <p className="font-['Cormorant_Garamond'] text-[#2c1a08] text-5xl font-light">$1,200</p>
                  <p className="text-[#b8892a] text-base font-medium">or $100 / month</p>
                </div>
                <p className="text-[#5a4030] text-sm mt-2 leading-relaxed">Covers tuition, residence, meals, books, and full spiritual formation for one child.</p>
              </div>
      ...
      <section className="py-20 px-6 bg-[#f4ede0]">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-[#5a4030] text-base mb-10">
            ...
            {[
              ...
              <div key={tel} className="flex flex-col gap-2">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 bg-[#25d366] hover:bg-[#1fba59] text-white font-medium px-7 py-3 rounded-2xl transition-colors text-base"
                >
