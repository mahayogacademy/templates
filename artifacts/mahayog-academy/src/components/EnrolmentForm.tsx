      ...
      <form onSubmit={handleSubmit}>
        <div className="bg-[#fdf6ec]/90 backdrop-blur-sm border border-[#c8a050]/30 rounded-2xl p-7 space-y-5">
          ...
          {slot === "m-health" && <>
            ...
            <div>
              <label className={lc}>Do you have any injuries or limitations that may affect sitting, movement, or breathwork? *</label>
              <div className="flex gap-6 mt-2">
                {["Yes", "No"].map(v => (
                  <label key={v} className="flex items-center gap-2 cursor-pointer">
            ...
            <div>
              <label className={lc}>Is there anything about your physical or mental well-being the instructor should be aware of?</label>
